...
time.sleep(5) #aqui estou pedindo 5s para conseguir sair dessa tela e colocar o mouse na posição que quero

#print() pedindo pra mostrar algo no terminal 
#o pyautogui.position(), nos mostra onde esta a posiçao do mouse
print(pyautogui.position()) #neste exemplo estamos pedindo para mostrar no terminal a posição do mouse
